...
int main()
{
	...
	GLFWwindow* Window = glfwCreateWindow(Width, Height, "Projeto Blue Marble - Computação Gráfica", nullptr, nullptr);
	...
	GLuint CloudsTextureId = LoadTexture("textures/nuvens.jpg");
